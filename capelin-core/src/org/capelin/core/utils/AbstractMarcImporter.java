...
public abstract class AbstractMarcImporter {
	...
	//protected List<String> totalTags = new UniqueList<String>();
	...
	//protected abstract int importData(boolean flag) throws Exception;

	
	//protected abstract CapelinRecord mapToRecord(Map<String, List<String>> dataMap);
	
	//protected abstract CapelinRecord specialProcess(CapelinRecord r, Map<String, List<String>> map, Record marcRecord);
}
