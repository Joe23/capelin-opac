...
public class DbAllTest extends TestCase {
	...
	public void _testList() {
		List<SampleTxRecord> l = (List<SampleTxRecord>) dao.listPaged("title",
				"a%", 1, true).getResultList();
		...
		l = (List<SampleTxRecord>) dao.listPaged("title", "b%", 1, true)
				.getResultList();
		assertEquals(2, l.size());
		assertEquals(titles.get(3), l.get(1).getTitle());
		assertEquals(titles.get(4), l.get(0).getTitle());

		l = (List<SampleTxRecord>) dao.listPaged("author", "A%", 1, true)
				.getResultList();
		assertEquals(3, l.size());
		...
		l = (List<SampleTxRecord>) dao.listPaged("author", "A%", 2, true)
				.getResultList();
